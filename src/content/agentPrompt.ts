...
- Write bodies for sections and items wrap the content: POST/PATCH a section sends {type, page_id, data: {...}, is_hidden?} and an item sends {data: {...}, is_hidden?}. Posting bare fields creates an EMPTY draft record (drafts accept it), so always nest under the data key. Pages, posts, and blogs take their fields at the top level.
